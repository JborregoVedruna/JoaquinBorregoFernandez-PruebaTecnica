...
/**
 * Clase de prueba para {@link HandlerExceptionController}.
 *
 * <p>Verifica que las excepciones se conviertan correctamente en respuestas {@link ProblemDetail}
 * siguiendo el estándar RFC 7807.
 */
class HandlerExceptionControllerTest {

  /** Instancia del controlador de excepciones bajo prueba. */
  private final HandlerExceptionController handler = new HandlerExceptionController();

  /** Mock de la petición web. */
  private final WebRequest request = mock(WebRequest.class);

  // ========== MethodArgumentTypeMismatchException ==========

  /**
   * Verifica la respuesta ante un error de tipo en los argumentos de los métodos (con tipo
   * requerido).
   */
  @Test
  ...
  /**
   * Verifica la respuesta ante un error de tipo en los argumentos de los métodos (sin tipo
   * requerido).
   */
  @Test
  ...
  /** Verifica la respuesta ante una excepción de tipo inesperado en la validación. */
  @Test
  ...
  /** Verifica la gestión de IllegalArgumentException con mensaje personalizado. */
  @Test
  ...
  /**
   * Verifica la gestión de IllegalArgumentException con mensaje nulo (debe usar mensaje por
   * defecto).
   */
  @Test
  ...
  /** Verifica la gestión de LoanApplicationNotFoundException con mensaje. */
  @Test
  ...
  /** Verifica la gestión de LoanApplicationNotFoundException con mensaje nulo. */
  @Test
  ...
  /** Verifica la gestión de EmptyResultDataAccessException. */
  @Test
  ...
  /** Verifica la gestión de DataIntegrityViolationException (Conflictos de datos). */
  @Test
  ...
  /**
   * Verifica la gestión de HttpMessageNotReadableException (errores de parseo JSON) con causa raíz.
   */
  @Test
  ...
  /** Verifica la gestión de HttpMessageNotReadableException cuando la causa raíz es nula. */
  @Test
  ...
  /**
   * Verifica la gestión de ConstraintViolationException (errores de validación de Bean Validation).
   */
  @Test
  ...
  /**
   * Verifica la gestión de MethodArgumentNotValidException (errores en @Valid).
   *
   * @throws NoSuchMethodException Si el método de mock no existe.
   */
  @Test
  void handleMethodArgumentNotValid_WithDefaultMessage_ShouldReturnBadRequest()
  ...
  /**
   * Verifica la gestión de MethodArgumentNotValidException cuando el mensaje por defecto del error
   * de campo es nulo.
   *
   * @throws NoSuchMethodException Si el método de mock no existe.
   */
  @Test
  void handleMethodArgumentNotValid_WithNullDefaultMessage_ShouldReturnInvalidValue()
      throws NoSuchMethodException {
    BindingResult bindingResult = new BeanPropertyBindingResult(new Object(), "target");
  ...
  /** Verifica la gestión de ValidationException con mensaje. */
  @Test
  ...
  /** Verifica la gestión de ValidationException con mensaje nulo. */
  @Test
  ...
  /** Verifica la gestión de ValidationException con mensaje vacío o en blanco. */
  @Test
  ...
  /** Verifica la gestión de RollbackException (Error interno del servidor). */
  @Test
  ...
  /** Verifica la gestión de HttpRequestMethodNotSupportedException (Método no permitido). */
  @Test
  void handleHttpRequestMethodNotSupported_WithMessage_ShouldReturnMethodNotAllowed() {
    ...
    ProblemDetail body = (ProblemDetail) response.getBody();
    assertEquals(
        "HttpRequestMethodNotSupportedException: HTTP Method Not Allowed", body.getTitle());
  }

  /**
   * Verifica que la respuesta de método no soportado incluya la lista de métodos permitidos si
   * están disponibles.
   */
  @Test
  ...
  /** Verifica la gestión de HttpRequestMethodNotSupportedException con mensaje nulo. */
  @Test
  ...
  /** Verifica la gestión de HttpRequestMethodNotSupportedException con mensaje vacío. */
  @Test
  ...
  /** Verifica que no se incluyan métodos permitidos en la respuesta si la lista está vacía. */
  @Test
  void
      handleHttpRequestMethodNotSupported_WithEmptySupportedMethods_ShouldNotIncludeAllowedMethods() {
    HttpRequestMethodNotSupportedException ex = mock(HttpRequestMethodNotSupportedException.class);
  ...
  /**
   * Verifica la gestión de PropertyReferenceException (referencias a propiedades inexistentes en
   * JPA).
   */
  @Test
  ...
  /** Verifica la gestión de PropertyReferenceException con mensaje nulo. */
  @Test
  ...
  /** Verifica la gestión de PropertyReferenceException con mensaje vacío. */
  @Test
